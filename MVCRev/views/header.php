                                ...
                                <div class="login-bghny p-md-5 p-4 mx-auto mw-100">
                                    ...
                                    <form action="#" method="post">
                                        <div class="form-group">
                                            ...
                                            name="username"
                                                aria-describedby="emailHelp" placeholder="Enter User Name Or Email Or Mobile" required="">
                                        ...
                                        <div class="form-check mb-2">
                                            <div class="userhny-check">
                                                <a class="login-texthny" href="registration">Click here for new account</a>
                                            </div>
                                        </div>
